...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define(['apiclientcore', 'localassetmanager'], factory);
    } else if (typeof module === 'object' && module.exports) {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require('./apiclientcore'), require('./localassetmanager'));
    } else {
        // Browser globals (root is window)
        root.apiclientex = factory(root.apiclientcore, root.localassetmanager);
    }
}(this, function (ApiClient, localassetmanager) {
    'use strict';
